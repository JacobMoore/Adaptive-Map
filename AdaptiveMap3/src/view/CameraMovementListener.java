...
import static fr.inria.zvtm.event.ViewListener.SHIFT_MOD;
import static fr.inria.zvtm.event.ViewListener.WHEEL_DOWN;
 ...
 * @version Sep 28, 2011
 */
public class CameraMovementListener implements ViewListener {
	...
	public void mouseWheelMoved(ViewPanel pnl, short wheelDirection, int i,
		...
		if (enabled) {
			...
			canvas.updateZoomLevel((float) activeCamera.getLocation().getAltitude());
		}
	}
