...
public class Node {
	...
	public Node(String nodeTitle, String nodeDescription, String nodeChapter,
		...
		this.nodeDescription.setSpecialFont(new Font("Arial", Font.PLAIN,
				fontSize));
	...
	public Node(String nodeTitle, String nodeDescription, String nodeChapter,
		...
		nodeRectangle.setOwner(Node.class);
		nodeRectangle.setType("Node");
		this.nodeTitle.setSpecialFont(VText.getMainFont().deriveFont(
				titleFontSize * 1.0f));
		this.nodeDescription.setSpecialFont(VText.getMainFont().deriveFont(
	...
	public void realignNodeText() {
		...
		case FULL_DESCRIPTION:
			...
			long nodeAdjustedWidth = Math.max(
	...
	public void resizeFont(int newSize) {
		this.nodeTitle.setSpecialFont(nodeTitle.getFont().deriveFont(
				newSize * 1.0f));
