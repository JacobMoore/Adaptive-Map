...
//   private static String DOT = "/usr/bin/dot";	// Linux
   private static String DOT = "C:/Program Files (x86)/Graphviz 2.34/bin/dot.exe";	// Windows
   ...
   public byte[] getGraph(String dot_source, String type)
   {
      ...
      try {
         ...
         return null;
    	  ...
    	  System.err.println(ioe.getLocalizedMessage()); return null; 
    	  }
   }
   ...
   public int writeGraphToFile(byte[] img, String file)
   {
      ...
      return writeGraphToFile(img, to, false);
   }
    ...
    * @return Success: 1, Failure: -1
    */
   public int writeGraphToFile(byte[] img, File to, boolean append)
   {
      try {
         ...
         fos.close();
    	  ...
    	  System.err.println(ioe.getLocalizedMessage()); return -1; 
    	  }
      return 1;
   }
   ...
   private byte[] get_img_stream(File dot, String type)
   {
      ...
      try {
         ...
         String[] args = {DOT, "-Gnodesep=300.0f", "-T"+type, dot.getAbsolutePath(), "-o", img.getAbsolutePath()};
   ...
   /**
    * Parses a GraphViz text file to find the coordinates of the nodes
